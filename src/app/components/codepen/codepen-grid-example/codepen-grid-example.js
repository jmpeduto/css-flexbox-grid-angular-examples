function changeFlex(e, t) {
  for (
    ...
    n[r].addEventListener(
      ...
      function () {
        var e = this.value;
        this.l.setAttribute("class", "flex-container " + e);
      },
      !1
    );
}
...
function changeItemFlex(e, t) {
  for (
    ...
    n[r].addEventListener(
      ...
      function () {
        var e = this.value;
        this.l.setAttribute("class", "item " + e);
      },
      !1
    );
}
...
function changeFlexBasis(e, t) {
  ...
  console.log("B: " + n);
    (document.querySelector("#" + t).style.WebkitFlexBasis = n + "px");
    (document.querySelector("#" + t).style.flexBasis = n + "px");
}
